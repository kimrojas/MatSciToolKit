...
from matscitoolkit.utils.plot import plot_atoms, plot_cell
...
class DFTrunner:
    ...
    def __init__(
        ...
        self.espresso_binary = espresso_binary
        self.espresso_pseudopath = espresso_pseudopath
    ...
    def make_espresso_args(self, i_edir, i_emaxpos):
        ...
        espresso_args = {
            ...
            "profile": EspressoProfile(binary=self.espresso_binary, pseudo_path=self.espresso_pseudopath),
        }
